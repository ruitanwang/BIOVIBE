export default function VolcanoTool() {
  return (
    <div className="tools-workspace">
      <div className="tools-work-header">
        <div className="tools-work-title-area">
          <span className="tools-work-icon">{'\u{1F30B}'}</span>
          <h3 className="tools-work-title">火山图</h3>
        </div>
        <span className="tools-work-desc">差异表达基因火山图</span>
      </div>
