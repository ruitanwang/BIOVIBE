export default function GSEATool() {
  return (
    <div className="tools-workspace">
      <div className="tools-work-header">
        <div className="tools-work-title-area">
          <span className="tools-work-icon">{'\u{1F50D}'}</span>
          <h3 className="tools-work-title">GSEA分析</h3>
        </div>
        <span className="tools-work-desc">基因集富集分析</span>
      </div>
