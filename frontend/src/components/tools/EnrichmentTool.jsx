export default function EnrichmentTool() {
  return (
    <div className="tools-workspace">
      <div className="tools-work-header">
        <div className="tools-work-title-area">
          <span className="tools-work-icon">{'\u{1F9EC}'}</span>
          <h3 className="tools-work-title">富集分析</h3>
        </div>
        <span className="tools-work-desc">GO / KEGG 功能富集分析</span>
      </div>
          ...
          <div className="tools-config-form">
            ...
            <div className="tools-config-field">
              ...
              <select className="tools-select">
                <option value="go">GO 富集</option>
                <option value="kegg">KEGG 富集</option>
              </select>
            </div>
            <div className="tools-config-field">
              <label>输出格式</label>
