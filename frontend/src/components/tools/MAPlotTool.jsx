export default function MAPlotTool() {
  return (
    <div className="tools-workspace">
      <div className="tools-work-header">
        <div className="tools-work-title-area">
          <span className="tools-work-icon">{'\u{1F4C9}'}</span>
          <h3 className="tools-work-title">MA图</h3>
        </div>
        <span className="tools-work-desc">M-A 散点图</span>
      </div>
