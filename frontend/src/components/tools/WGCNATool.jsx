export default function WGCNATool() {
  return (
    <div className="tools-workspace">
      <div className="tools-work-header">
        <div className="tools-work-title-area">
          <span className="tools-work-icon">{'\u{1F517}'}</span>
          <h3 className="tools-work-title">WGCNA</h3>
        </div>
        <span className="tools-work-desc">加权基因共表达网络分析</span>
      </div>
