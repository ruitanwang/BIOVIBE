export default function CircosTool() {
  return (
    <div className="tools-workspace">
      <div className="tools-work-header">
        <div className="tools-work-title-area">
          <span className="tools-work-icon">{'\u{1F300}'}</span>
          <h3 className="tools-work-title">Circos图</h3>
        </div>
        <span className="tools-work-desc">基因组圈图可视化</span>
      </div>
