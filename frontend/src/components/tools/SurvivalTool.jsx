    ...
    <div className="tools-workspace">
      <div className="tools-work-header">
        <div className="tools-work-title-area">
          <span className="tools-work-icon">{'\u{23F0}'}</span>
          <h3 className="tools-work-title">生存分析</h3>
        </div>
        <span className="tools-work-desc">Kaplan-Meier / Cox 回归分析</span>
      </div>
          ...
          <div className="tools-config-form">
            ...
            <div className="tools-config-field">
              ...
              <select className="tools-select">
                ...
                <option value="cox">Cox 回归</option>
              </select>
            </div>
            <div className="tools-config-field">
              <label>输出格式</label>
